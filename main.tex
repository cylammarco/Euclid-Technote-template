...
%
\usepackage[pdfauthor={YOUR NAME}, bookmarks=true, colorlinks=true, linktoc=section, linkcolor=black]{hyperref} 
\usepackage{tocloft} 
...
\fancyhead[C]{
    \color{light-gray}{
        ...
        \hline
        \multirow{4}{*}{\includegraphics[width=2cm]{logo.png}} % LOGO
        %\multirow{4}{*}{\Huge{EC}} % LOGO
        &\multirow{4}{*}{\pbox{7.5cm}{\Large{SOME TOPIC}}}
